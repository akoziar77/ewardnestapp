    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="px-6 py-4">
        <div className="relative overflow-hidden rounded-3xl bg-primary p-6 text-primary-foreground shadow-xl shadow-primary/15">
          <div className="relative z-10">
            ...
            <p className="mt-1 text-4xl font-bold tabular-nums tracking-tight">0</p>
            <div className="mt-4 flex items-center gap-2 text-sm opacity-80">
              <TrendingUp className="h-4 w-4" />
              <span>No activity yet — start scanning!</span>
            </div>
          </div>
          {/* Decorative circles */}
      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { icon: QrCode, label: "Scan", color: "bg-primary/10 text-primary" },
            { icon: Gift, label: "Rewards", color: "bg-secondary/10 text-secondary" },
            { icon: Bird, label: "My Nest", color: "bg-primary/10 text-primary" },
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-8 text-center">
        ...
        <Button variant="outline" className="mt-4 active:scale-[0.97]">
          Browse merchants
        </Button>
      </div>
    </div>
